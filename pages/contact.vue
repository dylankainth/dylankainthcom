<template>
  <div>
    ...
    <div
      class="p-5 mb-4 secondarystyledcard rounded-3 shadow"
      v-show="unlocked"
    >
      ...
      <div class="display-6 pt-2">
        ...
        <a
          href="https://www.snapchat.com/add/dylan-kainth?share_id=2ZbbATZYxtc&locale=en-GB"
          class="contactlink"
          target="_blank"
        >
          <div class="row align-items-start">
    ...
    <div class="row align-items-md-stretch">
      <div class="col-md-4 mb-4">
        <div
          class="h-100 p-5 imagedstyledcard rounded-3 shadow d-flex flex-column"
        >
