<template>
  <div>
    ...
    <div v-if="$route.params.tag == 'Team Enigma'" class="p-5 mb-4 rounded-3 shadow"
      ...
      <div class="container-fluid py-5">
        <div class="row align-items-start">
          ...
          <div class="col my-auto">
            <div class="h-100 p-5 rounded-3 shadow d-flex flex-column" style="background-color:#2F5452">
              <h1>Visit TE.</h1>
    ...
    <div v-if="$route.params.tag == 'RIE'" class="p-5 mb-4 rounded-3 shadow"
      ...
      <div class="container-fluid py-5">
        ...
        <div class="row align-items-start">
          ...
          <div class="col my-auto">
            <div class="h-100 p-5 rounded-3 shadow d-flex flex-column" style="background-color:#E2231A">
              <h1 style="color: #FFFFFF" class="kclsecondaryfont">Visit RIE on KCLSU.</h1>
              <a type="button" class="btn btn-outline-light btn-lg kclprimaryfont"
                href="https://www.kclsu.org/groups/activities/join/rie/">Let's Go</a>
    ...
    <div v-if="$route.params.tag == 'School'" class="p-5 mb-4 rounded-3 shadow"
      ...
      <div class="container-fluid py-5">
        <div class="row align-items-start">
          ...
          <div class="col my-auto">
            <div class="h-100 p-5 rounded-3 shadow d-flex flex-column" style="background-color:#393939">
    ...
    <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5" v-if="filtered">
      <div class="col" v-for="(project, id) in filteredprojects" v-bind:key="id">
...
export default {
  ...
  mounted() {
    for (let x in this.$store.state.projects) {
      var tags = this.$store.state.projects[x].tags
      var referencetag = this.$route.params.tag

      if (tags.some(x => x.toLowerCase() == referencetag.toLowerCase()) == true) {
